const places = [
  ...
  {
    id: 6,
    maps: "https://maps.google.com/?q=Tarkwa+Bay+Beach+Lagos",
    name: "Tarkwa Bay Beach",
    address: "Tarkwa Bay Island, Lagos Harbour",
    description: "Accessible only by boat, Tarkwa Bay sits inside Lagos Harbour like a well-kept secret. The water is calm and sheltered, the crowd is smaller than the mainland beaches, and the short ferry ride across the harbour feels like leaving the city behind entirely.",
    image: "images/tarkwa-bay.webp",
    alt: "Calm sheltered waters and sandy shoreline of Tarkwa Bay Beach in Lagos Harbour"
  },
  {
    id: 7,
    maps: "https://maps.google.com/?q=Freedom+Park+Lagos+Island",
    name: "Freedom Park Lagos",
    address: "1 Hospital Road, Lagos Island, Lagos",
    description: "What was once a colonial-era prison where freedom fighters were held now stands as one of Lagos most thoughtful cultural spaces. Freedom Park hosts live concerts, art exhibitions, and open-air theatre performances on the very ground where resistance once lived.",
    image: "images/freedom-park.webp",
    alt: "Open air cultural space and green grounds of Freedom Park on Lagos Island"
  },
  {
    id: 8,
    maps: "https://maps.google.com/?q=Lekki-Ikoyi+Link+Bridge+Lagos",
    name: "Lekki-Ikoyi Link Bridge",
    address: "Ozumba Mbadiwe Avenue, Victoria Island, Lagos",
    description: "The Lekki-Ikoyi Link Bridge is the kind of structure that makes you pull out your phone before you even think about it. This cable-stayed bridge arches gracefully over the Lagos Lagoon, connecting two of the city's most dynamic neighbourhoods while offering some of the finest views of the Lagos skyline you will find anywhere.",
    image: "images/lekki-ikoyi-bridge.webp",
    alt: "Cable-stayed Lekki-Ikoyi Link Bridge arching over the Lagos Lagoon at dusk"
  }
];
